...
class FrogPondDun1 extends TownState
{
	...
	override public function create():Void
	{
		...
		chest1 = new Chest(0, 0, FlxObject.UP, this, "frogpond_chest1");
		chest2 = new Chest(0, 0, FlxObject.UP, this, "frogpond_chest2");
		chest3 = new Chest(0, 0, FlxObject.UP, this, "frogpond_chest3");
		chest4 = new Chest(0, 0, FlxObject.UP, this, "frogpond_chest4");
		mimic1 = new Chest(0, 0, FlxObject.DOWN, this, "frogpond_mimic1");
		mimic2 = new Chest(0, 0, FlxObject.DOWN, this, "frogpond_mimic2");
		mimic3 = new Chest(0, 0, FlxObject.DOWN, this, "frogpond_mimic3");
		mimic4 = new Chest(0, 0, FlxObject.DOWN, this, "frogpond_mimic4");
		mimic5 = new Chest(0, 0, FlxObject.DOWN, this, "frogpond_mimic5");
		mimic6 = new Chest(0, 0, FlxObject.DOWN, this, "frogpond_mimic6");
		mimic7 = new Chest(0, 0, FlxObject.DOWN, this, "frogpond_mimic7");
		mimic8 = new Chest(0, 0, FlxObject.DOWN, this, "frogpond_mimic8");
		grpNPCs.add(chest1);
		grpNPCs.add(chest2);
		grpNPCs.add(chest3);
		grpNPCs.add(chest4);
		...
		{
			door1 = new NPC(0, 0, FlxObject.UP, 9, this, "frogpond_door1");
			grpNPCs.add(door1);
		}
		if (Reg.flags["frogpond_door2"] == 0)
		{
			door2 = new NPC(0, 0, FlxObject.UP, 9, this, "frogpond_door2");
			grpNPCs.add(door2);
		}
		if (Reg.flags["frogpond_door3"] == 0)
		{
			door3 = new NPC(0, 0, FlxObject.UP, 9, this, "frogpond_door3");
			grpNPCs.add(door3);
		}
		if (Reg.flags["frogpond_door4"] == 0)
		{
			door4 = new NPC(0, 0, FlxObject.UP, 9, this, "frogpond_door4");
			grpNPCs.add(door4);
		}

		if (Reg.flags["frogpond_obs1"] == 0)
		{
			obs1 = new NPC(0, 0, FlxObject.UP, 14, this, "frogpond_obs1");
			grpNPCs.add(obs1);
		}
		if (Reg.flags["frogpond_obs2"] == 0)
		{
			obs2 = new NPC(0, 0, FlxObject.UP, 14, this, "frogpond_obs2");
			grpNPCs.add(obs2);
		}
		if (Reg.flags["frogpond_obs3"] == 0)
		{
			obs3 = new NPC(0, 0, FlxObject.UP, 14, this, "frogpond_obs3");
			grpNPCs.add(obs3);
		}
		if (Reg.flags["frogpond_obs4"] == 0)
		{
			obs4 = new NPC(0, 0, FlxObject.UP, 14, this, "frogpond_obs4");
			grpNPCs.add(obs4);
		}
