...
class FrogPondDun1 extends Dungeon
{
	var chest1:Chest;
	var chest2:Chest;
	var chest3:Chest;
	...
	override public function create():Void
	{
		...
		chest1 = new Chest(0, 0, FlxObject.UP, Reg.npcs["chest1_closed"], this, "frogpond_chest1");
		chest2 = new Chest(0, 0, FlxObject.UP, Reg.npcs["chest1_closed"], this, "frogpond_chest2");
		chest3 = new Chest(0, 0, FlxObject.UP, Reg.npcs["chest1_closed"], this, "frogpond_chest3");
		chest4 = new Chest(0, 0, FlxObject.UP, Reg.npcs["chest1_closed"], this, "frogpond_chest4");
		mimic1 = new Chest(0, 0, FlxObject.DOWN, Reg.npcs["chest1_closed"], this, "frogpond_mimic1");
		mimic2 = new Chest(0, 0, FlxObject.DOWN, Reg.npcs["chest1_closed"], this, "frogpond_mimic2");
		mimic3 = new Chest(0, 0, FlxObject.DOWN, Reg.npcs["chest1_closed"], this, "frogpond_mimic3");
		mimic4 = new Chest(0, 0, FlxObject.DOWN, Reg.npcs["chest1_closed"], this, "frogpond_mimic4");
		mimic5 = new Chest(0, 0, FlxObject.DOWN, Reg.npcs["chest1_closed"], this, "frogpond_mimic5");
		mimic6 = new Chest(0, 0, FlxObject.DOWN, Reg.npcs["chest1_closed"], this, "frogpond_mimic6");
		mimic7 = new Chest(0, 0, FlxObject.DOWN, Reg.npcs["chest1_closed"], this, "frogpond_mimic7");
		mimic8 = new Chest(0, 0, FlxObject.DOWN, Reg.npcs["chest1_closed"], this, "frogpond_mimic8");
		grpNPCs.add(chest1);
		grpNPCs.add(chest2);
		grpNPCs.add(chest3);
		grpNPCs.add(chest4);
		...
		{
			door1 = new NPC(0, 0, FlxObject.UP, Reg.npcs["door1"], this, "frogpond_door1");
			grpNPCs.add(door1);
		}
		if (Reg.flags["frogpond_door2"] == 0)
		{
			door2 = new NPC(0, 0, FlxObject.UP, Reg.npcs["door1"], this, "frogpond_door2");
			grpNPCs.add(door2);
		}
		if (Reg.flags["frogpond_door3"] == 0)
		{
			door3 = new NPC(0, 0, FlxObject.UP, Reg.npcs["door1"], this, "frogpond_door3");
			grpNPCs.add(door3);
		}
		if (Reg.flags["frogpond_door4"] == 0)
		{
			door4 = new NPC(0, 0, FlxObject.UP, Reg.npcs["door1"], this, "frogpond_door4");
			grpNPCs.add(door4);
		}

		if (Reg.flags["frogpond_obs1"] == 0)
		{
			obs1 = new NPC(0, 0, FlxObject.UP, Reg.npcs["tempwall"], this, "frogpond_obs1");
			grpNPCs.add(obs1);
		}
		if (Reg.flags["frogpond_obs2"] == 0)
		{
			obs2 = new NPC(0, 0, FlxObject.UP, Reg.npcs["tempwall"], this, "frogpond_obs2");
			grpNPCs.add(obs2);
		}
		if (Reg.flags["frogpond_obs3"] == 0)
		{
			obs3 = new NPC(0, 0, FlxObject.UP, Reg.npcs["tempwall"], this, "frogpond_obs3");
			grpNPCs.add(obs3);
		}
		if (Reg.flags["frogpond_obs4"] == 0)
		{
			obs4 = new NPC(0, 0, FlxObject.UP, Reg.npcs["tempwall"], this, "frogpond_obs4");
			grpNPCs.add(obs4);
		}
	...
	override public function assignEvents():Void
	{
		...
		{
			chest1.events = [new EventFlag("frogpond_chest1", 1),
		...
		{
			chest2.events = [new EventFlag("frogpond_chest2", 1),
		...
		{
			chest3.events = [new EventFlag("frogpond_chest3", 1),
		...
		{
			chest4.events = [new EventFlag("frogpond_chest4", 1),
							 new EventNPCTrigger(chest4),
		...
		{
			mimic1.events = [new EventFlag("frogpond_mimic1", 1),
							 new EventNPCTrigger(mimic1),
							 new EventDialog(Strings.frogponddunStrings[15], this),
		...
		{
			mimic2.events = [new EventFlag("frogpond_mimic2", 1),
							 new EventNPCTrigger(mimic2),
							 new EventDialog(Strings.frogponddunStrings[15], this),
		...
		{
			mimic3.events = [new EventFlag("frogpond_mimic3", 1),
							 new EventNPCTrigger(mimic3),
							 new EventDialog(Strings.frogponddunStrings[15], this),
		...
		{
			mimic4.events = [new EventFlag("frogpond_mimic4", 1),
							 new EventNPCTrigger(mimic4),
							 new EventDialog(Strings.frogponddunStrings[15], this),
		...
		{
			mimic5.events = [new EventFlag("frogpond_mimic5", 1),
							 new EventNPCTrigger(mimic5),
							 new EventDialog(Strings.frogponddunStrings[15], this),
		...
		{
			mimic6.events = [new EventFlag("frogpond_mimic6", 1),
							 new EventNPCTrigger(mimic6),
							 new EventDialog(Strings.frogponddunStrings[15], this),
		...
		{
			mimic7.events = [new EventFlag("frogpond_mimic7", 1),
							 new EventNPCTrigger(mimic7),
							 new EventDialog(Strings.frogponddunStrings[15], this),
		...
		{
			mimic8.events = [new EventFlag("frogpond_mimic8", 1),
							 new EventNPCTrigger(mimic8),
							 new EventDialog(Strings.frogponddunStrings[15], this),
